...
import { orderTypes, shortenLargeNumbers } from '@/shared/utils/utils.service';
import { socket, socketService } from '@/sockets/socket.service';

import BuyerTable from '@/features/buyer/components/BuyerTable';
            ...
            <li className="inline-block py-3 uppercase" onClick={() => setType(BUYER_GIG_STATUS.ACTIVE)}>
              ...
              >
                ...
                {orderTypes(BUYER_GIG_STATUS.IN_PROGRESS, orders) > 0 && (
                  <span className="ml-1 rounded-[5px] bg-orange-500 px-[5px] py-[1px] text-xs font-medium text-white">
