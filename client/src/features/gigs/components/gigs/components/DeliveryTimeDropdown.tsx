        ...
        <Button
          ...
          label={
            <>
              ...
              {!toggleDropdown ? (
                <FaChevronDown className="mt-§ float-right h-4 fill-current text-slate-900" />
              ) : (
                <FaChevronUp className="mt-§ float-right h-4 fill-current text-slate-900" />
              )}
            </>
          }
        ...
        {toggleDropdown && (
          <div className="absolute z-50 mt-2 w-96 divide-y divide-gray-100 rounded-lg border border-slate-100 bg-white drop-shadow-md sm:w-72">
                  ...
                  <div className="flex rounded p-2">
                    <div className="flex h-5 items-center">
                      <Input
                        ...
                        type="radio"
                        value={selectedTime}
                        className="dark:focus:ring-red-orange-500 h-4 w-4 bg-gray-100 text-red-600 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700"
            ...
            <div className="my-4 flex cursor-pointer justify-evenly pt-3">
              ...
              <div
                className="rounded bg-orange-500 px-4 py-2 text-sm font-bold text-white hover:bg-orange-400"
                onClick={() => {
