...
import { SellerContext } from '@/features/sellers/context/SellerContext';
import { IExperience, IExperienceEditProps } from '@/features/sellers/interfaces/seller.interface';
import Button from '@/shared/Button';
import Textarea from '@/shared/Textarea';
import Input from '@/shared/Input';
import { yearsList } from '@/shared/utils/utils.service';
        ...
        <div className="mb-6 px-3 md:mb-16">
          ...
          <div className="mb-4 mt-2 flex items-center">
            <Input
              ...
              className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-red-600"
          ...
          <div className="mb-5 flex items-center">
            <Textarea
              className="border-grey focus:border-grey block w-full rounded border p-2.5 text-sm text-gray-900 focus:ring-red-500"
