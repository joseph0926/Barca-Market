...
import { IEducation, IEducationEditProps } from '@/features/sellers/interfaces/seller.interface';
import Button from '@/shared/Button';
import Input from '@/shared/Input';
import { countriesList, degreeList, yearsList } from '@/shared/utils/utils.service';
