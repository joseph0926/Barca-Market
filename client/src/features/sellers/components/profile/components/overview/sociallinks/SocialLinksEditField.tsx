...
import { ISocialEditLinksProps } from '@/features/sellers/interfaces/seller.interface';
    ...
    <div className="flex w-full flex-col">
      ...
      <div className="z-20 my-4 mt-10 flex cursor-pointer justify-center md:z-0 md:mt-0">
        <Button
          ...
          className={`md:text-md rounded bg-orange-500 px-6 py-1 text-center text-sm font-bold text-white
          hover:bg-orange-400 focus:outline-none md:py-2 ${
