...
import { IProfileHeaderProps, ISellerProfileItem, IShowEditItem } from '@/features/sellers/interfaces/seller.interface';
            ...
            <div className="flex cursor-pointer self-center md:block md:self-start">
              ...
              {showItemEdit.fullname && (
                <div className="flex gap-x-4">
                  <Input
                    className="mt-2 flex h-7 w-full items-center rounded border border-gray-300 p-1.5 text-sm font-normal text-gray-600 focus:border focus:border-orange-500/50 focus:outline-none lg:h-9"
