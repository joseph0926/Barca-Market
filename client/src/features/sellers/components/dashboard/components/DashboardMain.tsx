...
import { SellerContextType } from '@/features/sellers/interfaces/seller.interface';
          ...
          <ul className="flex w-full cursor-pointer list-none flex-col px-6 md:flex-row">
            <li
              ...
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm ${
                type === 'active' ? 'text-orange-500 md:border-b-2 md:border-orange-500' : ''
              }`}
            >
              ACTIVE GIGS
            </li>
            <li
              ...
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm ${
                type === 'paused' ? 'text-orange-500 md:border-b-2 md:border-orange-500' : ''
              }`}
            >
              PAUSED
            </li>
            <li
              ...
              className={`mr-9 w-full py-3 text-xs font-bold md:w-auto md:py-5 md:text-sm ${
                type === 'orders' ? 'text-orange-500 md:border-b-2 md:border-orange-500' : ''
              }`}
            >
              ACTIVE ORDERS
            </li>
