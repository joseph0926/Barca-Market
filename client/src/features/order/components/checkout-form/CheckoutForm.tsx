...
import CheckoutFormSkeleton from '@/features/order/components/checkout-form/CheckoutFormSkeleton';
    ...
    <form id="payment-form" onSubmit={handleSubmit}>
      ...
      <Button
        ...
        className={`w-full rounded px-6 py-3 text-center text-sm font-bold text-white focus:outline-none md:px-4 md:py-2 md:text-base ${
          isLoading || !stripe || !elements ? 'cursor-not-allowed bg-orange-200' : 'bg-orange-500 hover:bg-orange-400'
        }`}
