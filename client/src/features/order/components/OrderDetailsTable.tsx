...
import { IOrderInvoice, IOrderProps } from '@/features/order/interfaces/order.interface';
                ...
                <div className="flex justify-between">
                  <div className="flex gap-2 text-sm md:text-base">
                    <div className="flex gap-2">
                      Buyer:
                      <Link to="" className="font-bold text-red-400 hover:underline">
                        {order.buyerUsername}
                      </Link>
                    </div>
                  ...
                  {order.buyerUsername === authUser.username && (
                    ...
                    >
                      <div className="cursor-pointer text-red-400 underline">Download invoice</div>
                    </PDFDownloadLink>
                  )}
                </div>
                <div className="mt-4">
