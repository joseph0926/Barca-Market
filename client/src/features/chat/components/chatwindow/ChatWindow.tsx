...
import OfferModal from '@/shared/modals/OfferModal';
import { checkFile, fileType, readAsBase64 } from '@/shared/utils/image-utils.service';
import { TimeAgo } from '@/shared/utils/timeago';
import { firstLetterUppercase, showErrorToast } from '@/shared/utils/utils.service';
                ...
                <div key={uuidv4()} className="mb-4">
                  <div className="flex w-full cursor-pointer items-center space-x-4 px-5 py-2 hover:bg-[#f5fbff]">
                    <div className="flex self-start">
                      <img className="h-10 w-10 rounded-full object-cover" src={message.senderPicture} alt="" />
                    </div>
