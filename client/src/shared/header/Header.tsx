...
import ForgotPasswordModal from '@/features/auth/components/ForgotPassword';
import LoginModal from '@/features/auth/components/Login';
import RegisterModal from '@/features/auth/components/Register';
import { IButtonProps } from '@/shared/interfaces/shared.interface';
                ...
                <div className="border-primary/10 -ml-1 flex w-full flex-col space-y-2 sm:flex-row md:w-max lg:space-y-0 lg:border-l dark:border-gray-700">
                  <div
                    ...
                    className="relative ml-auto flex h-9 items-center justify-center before:absolute
                            ...
                            hover:before:scale-105 focus:before:bg-orange-600/10 active:duration-75 active:before:scale-95
                            sm:px-6 dark:focus:before:bg-orange-400/10"
                  >
                  ...
                  <div
                    ...
                    className="relative ml-auto flex h-9 items-center justify-center rounded-full bg-orange-500
                            font-bold text-white hover:bg-orange-400 sm:px-6"
                  >
