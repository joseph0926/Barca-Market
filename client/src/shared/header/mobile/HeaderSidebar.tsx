      ...
      >
        <div className="z-2 sticky top-0 flex w-full flex-col items-start justify-start gap-6 bg-white">
          <div
            ...
            className="cursor-pointer rounded border border-orange-500 bg-orange-500 px-6 py-3 text-base font-semibold text-white transition-all duration-300"
          >
            Join Barca
          </div>
          <div
              ...
              >
                <ul>
                  {categories().map((category: string) => (
                    <li key={uuidv4()} className="flex cursor-pointer justify-between py-2 text-right hover:text-orange-400">
