...
import MessageDropdown from '@/shared/header/MessageDropdown';
import HomeHeaderSideBar from '@/shared/header/mobile/HomeHeaderSideBar';
import MobileHeaderSearchInput from '@/shared/header/mobile/MobileHeaderSearchInput';
                ...
                <div className="hidden w-full md:flex">
                  <label htmlFor="hbr" className="peer-checked:hamburger relative z-20 -ml-4 block cursor-pointer p-6 lg:hidden">
                    <Button
                      ...
                      label={
                        <>
                          {openSidebar ? <FaTimes className="h-6 w-6 text-orange-500" /> : <FaBars className="h-6 w-6 text-orange-500" />}
                        </>
                      }
                    />
                  </label>
                  ...
                  <ul className="flex text-base font-medium">
                    ...
                    {buyer && !buyer.isSeller && (
                      <li className="relative flex items-center">
                        <Link
                          ...
                          className="relative ml-auto flex h-9 items-center justify-center rounded-full bg-orange-500 font-bold text-white hover:bg-orange-400 sm:px-6"
                        >
                    ...
                    <li className="relative z-50 flex cursor-pointer items-center">
                      <Button
                        ...
                        label={
                          <>
                            <img src={`${authUser.profileImage}`} alt="profile" className="h-7 w-7 rounded-full object-cover" />
              ...
              <div className="justify-left md:justify-left container mx-auto flex px-6 lg:justify-center">
                ...
                >
                  {categories().map((category: string) => (
                    <span key={uuidv4()} className="mx-4 cursor-pointer first:ml-0 hover:text-orange-400 lg:mx-0">
