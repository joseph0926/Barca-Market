...
import { IBannerProps } from '@/shared/interfaces/shared.interface';
      ...
      <div className="mx-auto flex items-center">
        <div className="flex items-center text-sm font-bold text-white">
          ...
          <span className="flex gap-2">
            {text}
            {showLink && (
              <div onClick={onClick} className="inline cursor-pointer font-medium text-red-500 no-underline hover:underline">
                {linkText}
              </div>
            )}
          </span>
