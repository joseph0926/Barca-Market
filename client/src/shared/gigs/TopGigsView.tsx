...
import GigIndexItem from '@/features/index/gig-tabs/GigIndexItem';
    ...
    <div className="mx-auto my-8 flex flex-col overflow-hidden rounded-lg">
        ...
        <div className="flex items-start py-6">
          <div className="flex w-full flex-col justify-between">
            <div className="flex gap-2">
              ...
              {category && (
                <span className="flex cursor-pointer self-center text-base font-bold text-orange-500 hover:text-orange-400 hover:underline md:text-lg lg:text-2xl">
      ...
      <div className="m-auto flex h-96 w-full overflow-x-auto" ref={navElement}>
        {scroll.start && gigs.length > 2 && (
          <span
            onClick={slideLeft}
            className="absolute left-2 z-50 flex cursor-pointer justify-start self-center rounded-full bg-orange-400 sm:left-3 md:left-7 lg:left-0"
          >
        ...
        {!scroll.end && gigs.length > 2 && (
          <span
            onClick={slideRight}
            className="absolute right-2 flex max-w-4xl cursor-pointer justify-end self-center rounded-full bg-orange-400 sm:right-3 md:right-7 lg:right-0"
          >
