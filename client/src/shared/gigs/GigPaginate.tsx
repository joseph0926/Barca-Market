      ...
      <ul className="flex gap-8">
        <div
          className={`cursor-pointer p-3 ${
            itemOffset - 1 > 0 ? 'rounded-full border border-orange-400' : 'cursor-not-allowed text-gray-400'
          }`}
          onClick={() => {
            if (itemOffset - 1 > 0) {
              itemOffset -= 1;
        ...
        <div
          className={`cursor-pointer p-3 ${
            itemOffset === paginationCount.length ? 'cursor-not-allowed text-gray-400' : 'rounded-full border border-orange-400'
          }`}
          onClick={() => {
